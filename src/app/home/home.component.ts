...
export class HomeComponent implements OnInit {
  ...
  expand(person) {
    ...
    if(person == "russell") {
      (<HTMLImageElement>document.getElementById("img01")).src = "assets/img/russell.png";
      ...
      (<HTMLImageElement>document.getElementById("img01")).src = "assets/img/brok.jpg";
      ...
      (<HTMLImageElement>document.getElementById("img01")).src = "assets/img/keaten.jpg";
      ...
      (<HTMLImageElement>document.getElementById("img01")).src = "assets/img/olivia.png";
      ...
      (<HTMLImageElement>document.getElementById("img01")).src = "assets/img/Taylor.jpg";
